...
package com.hj.app.common.casbin;
...
public class JDBCAdapter implements Adapter {
     ...
     */
    public JDBCAdapter(String dbname,String driver, String url, String username, String password) {
    	this.dbname = dbname;
        this.driver = driver;
        this.url = url;
     ...
     */
    public JDBCAdapter(String dbname,String driver, String url, String username, String password, boolean dbSpecified) {
    	this.dbname = dbname;
        this.driver = driver;
        this.url = url;
        this.username = username;
    ...
    public void removeFilteredPolicy(String sec, String ptype, int fieldIndex, String... fieldValues) {
        List<String> values = Optional.ofNullable(Arrays.asList(fieldValues)).orElse(new ArrayList<String>());
